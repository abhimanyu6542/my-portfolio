    ...
    projects: [
      {
        ...
        url: 'https://huntsjob.com',
        subdomains: [
          'recruiter.huntsjob.com',
          'event.huntsjob.com',
          'dashboard.huntsjob.com',
          'masters.dev.huntsjob.com',
        ],
        ...
        achievements: [
          'Contributed to a platform serving global staffing companies',
          'Implemented secure authentication system',
          'Improved API response times by 40%',
        ],
      },
      {
        name: 'PDOT Management System',
        tagline: 'Project Documentation & Tracking',
        description: 'Comprehensive project management and tracking system for enterprise clients.',
        technologies: [
          { name: 'C#', icon: Code },
          { name: 'MVC', icon: Globe },
          { name: 'SQL Server', icon: Database },
      ...
      {
        name: 'Mobilization Portal',
        tagline: 'Employee Deployment Management',
        description: 'Employee mobilization and deployment management system for large organizations.',
        technologies: [
